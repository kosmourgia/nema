...
Birth an inert Object. Its Object, first Revision, Value, and physical locator
are distinct data:

```text
flix> let (w1, o) = Nema.Lab.Vivarium.birth("seed", Nema.Lab.Vivarium.Value.Text("asleep"), "urn:repl:seed", Nema.Lab.Vivarium.empty()); (Nema.Lab.Vivarium.showObject(o), Nema.Lab.Vivarium.describe(w1))
(O17, O17 object genesis="seed" locator=urn:repl:seed head=R40 payload=V70 revisions=1)
```

Attach a Pulse and driver, thereby making the same Object a live Observer:

```text
flix> let (w1, o) = Nema.Lab.Vivarium.birth("seed", Nema.Lab.Vivarium.Value.Text("asleep"), "urn:repl:seed", Nema.Lab.Vivarium.empty()); let (w2, p) = Nema.Lab.Vivarium.newPulse("repl", w1); let w3 = Nema.Lab.Vivarium.animate(o, p, Nema.Lab.Vivarium.Reaction.Notifier, w2); Nema.Lab.Vivarium.describe(w3)
O17 object genesis="seed" locator=urn:repl:seed head=R40 payload=V70 revisions=1
